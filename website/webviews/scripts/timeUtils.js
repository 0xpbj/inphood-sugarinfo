...
function getUserTimeObj(timeStampMs, userTimeZone) {
...
function getUserTimeString(timeStampMs, userTimeZone) {
  let userTime = getDateTimeInTZ(timeStampMs, userTimeZone)
...
function getUserDateString(timeStampMs, userTimeZone) {
